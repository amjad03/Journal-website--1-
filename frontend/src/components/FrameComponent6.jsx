            ...
            <div className={styles.navbarItem1}>
              <nav className={styles.navbarItem2}>
                <div className={styles.navbarItem3}>
                  <div className={styles.navbarItem4}>
                    <div className={styles.navbarItem5}>
                      <img
                    ...
                    <div className={styles.navbarItem6}>
                ...
                <div className={styles.navbarItem7}>
                ...
                <div className={styles.navbarItem8}>
            ...
            <div className={styles.main}>
              {/* <div className={styles.menu}>
                ...
                <div className={styles.rectangleContainer}>
                  ...
                  <b className={styles.editorialTeam}>Editorial Team</b>
                </div>
